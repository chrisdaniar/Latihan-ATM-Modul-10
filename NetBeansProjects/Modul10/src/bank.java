        ...
        try {
            do { 
                ...
                if (pin==1234) //cek pin
                        ...
                        switch (choice){
                            case 1:
                                ...
                                JOptionPane.showMessageDialog(null,"Terimakasih telah "
                                        + "menggunakan ATM BNI SYARIAH - BOJONEGORO, ambil kartu ATM Anda.");

                                System.exit(0);

                            case 2:

                            strl = JOptionPane.showInputDialog(null,"Masukkan "
                            ...
                            default: JOptionPane.showMessageDialog(null,"Pilihan menu "
                    ...
                    else if (counter<3){ //jika pin salah a--; 
